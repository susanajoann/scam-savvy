...
export const PHISHING_TEMPLATES = [
  {
    ...
    fromDisplay: "USPS Delivery <delivery@simulations.scam-savvy.org>",
    bodyHtml: `
  ...
  },
  {
    ...
    fromDisplay: "Account Security <alerts@simulations.scam-savvy.org>",
    bodyHtml: `
  ...
  },
  {
    ...
    fromDisplay: "Amazon <order-update@simulations.scam-savvy.org>",
    bodyHtml: `
